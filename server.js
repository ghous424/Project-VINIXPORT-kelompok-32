...
app.post('/api/register', (req, res) => {
    ...
    if (!name || !email || !password) {
        console.error('Registration failed: Missing name, email, or password.');
    ...
    db.query(checkQuery, [email], (err, results) => {
        ...
        bcrypt.hash(password, 10, (err, hashedPassword) => {
            ...
            const values = [name, email, hashedPassword, 'New Member', 'Tell us about yourself...', 'user', avatarUrl];
